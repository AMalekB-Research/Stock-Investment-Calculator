...
initally to practice applying loops, conditions and libraries 
leading me down a rabbit hole into financal logic to a real-world problem I care about.
Using the data to caclualte Compound Annoual Growth (CAGR), to predict year by year returns.
